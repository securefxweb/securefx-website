          ...
          <div className={styles.imageCenter}>
            ...
            <div className={styles.aboutshieldrelative}>
              ...
              <motion.div
                ...
                animate="animate"
              >
                <motion.div className={styles.animatingtextfirst} variants={textItem}>
                  <h2>15+ Years of Trust</h2>
                </motion.div>

                <motion.div className={styles.animatingtextsecond} variants={textItem}>
                  <h2>14000+ Global Traders</h2>
                </motion.div>

                <motion.div className={styles.animatingtextthird} variants={textItem}>
                  <h2>25K+ Active Accounts</h2>
                </motion.div>

                <motion.div className={styles.animatingtextfourth} variants={textItem}>
